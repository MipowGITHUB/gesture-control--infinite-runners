    ...
    while True:
        ...
        if result.multi_hand_landmarks:
            for hand_idx, hand_landmarks in enumerate(result.multi_hand_landmarks):
                ...
                # Menentukan gesture berdasarkan kondisi jari terbuka
                if jumlah_terbuka == 5:
                    gesture_text = 'UP'  # Telapan tangan terbuka
                elif jumlah_terbuka == 0:
                    gesture_text = 'DOWN'  # Telapak tangan tertutup
                elif jumlah_terbuka == 1 and ibuJari:  # Jempol terbuka
                    gesture_text = 'LEFT'  # Jempol di atas
